"""
Django settings for ddpacks_backend project.
...
SECRET_KEY = 'django-insecure-y3#7$!h10!zd5*2$t7o-+82$u*y6g+*t0mbekmg!gn0gat(un0'
...
ROOT_URLCONF = 'ddpacks_backend.urls'
...
WSGI_APPLICATION = 'ddpacks_backend.wsgi.application'
